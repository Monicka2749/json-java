...
public class FirstExample2 {
   ...
   // Jura Live
    ...
    static final String JSONUrl = "src/out/json/jura-live3.json";
        ...
        try{
           ...
           ResultSet rs = stmt.executeQuery(sql);
            ...
            try {
                ...
                jsonObjectMain.put("draw", "1");
                jsonObjectMain.put("recordsTotal", rs.getRow());
                jsonObjectMain.put("recordsFiltered", rs.getRow());
                fileWriter.write("[ \n");
            while(rs.next()) {
